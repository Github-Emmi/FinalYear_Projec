    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.CharField(default='', max_length=225)),
                ('height', models.CharField(default='', max_length=225)),
                ('weight', models.CharField(default='', max_length=225)),
                ('eye_color', models.CharField(default='', max_length=225)),
                ('place_of_birth', models.CharField(default='', max_length=225)),
                ('home_town', models.CharField(default='', max_length=225)),
                ('state_of_origin', models.CharField(default='', max_length=225)),
                ('lga', models.CharField(default='', max_length=225)),
                ('nationality', models.CharField(default='', max_length=225)),
                ('gender_choice', models.CharField(default='', max_length=225)),
                ('residential_address', models.CharField(default='', max_length=225)),
                ('bus_stop', models.CharField(default='', max_length=225)),
                ('religion', models.CharField(default='', max_length=225)),
                ('father_name', models.CharField(default='', max_length=225)),
                ('father_address', models.CharField(default='', max_length=225)),
                ('father_occupation', models.CharField(default='', max_length=225)),
                ('father_postion', models.CharField(default='', max_length=225)),
                ('father_phone_num_1', models.CharField(default='', max_length=225)),
                ('father_phone_num_2', models.CharField(default='', max_length=225)),
                ('mother_name', models.CharField(default='', max_length=225)),
                ('mother_address', models.CharField(default='', max_length=225)),
                ('mother_occupation', models.CharField(default='', max_length=225)),
                ('mother_position', models.CharField(default='', max_length=225)),
                ('mother_phone_num_1', models.CharField(default='', max_length=225)),
                ('mother_phone_num_2', models.CharField(default='', max_length=225)),
                ('last_class', models.CharField(default='', max_length=225)),
                ('school_attended_last', models.CharField(default='', max_length=225)),
                ...
                ('medical_history_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapp.medicalhistory')),
                ('session_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapp.sessionyearmodel')),
            ],
        ),
        migrations.CreateModel(
