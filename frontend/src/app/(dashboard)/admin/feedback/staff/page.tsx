  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {thread.subject && (
          <p className="truncate text-xs font-medium text-muted-foreground">{thread.subject}</p>
        )}
        {lastMsg && (
...
export default function AdminStaffFeedbackPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: queryKeys.feedback.threads({ role_filter: "staff", status: statusFilter || undefined }),
    queryFn: () =>
      listFeedbackThreads({
        role_filter: "staff",
        ...
        <div className="flex w-80 shrink-0 flex-col rounded-2xl border border-border bg-card shadow-sm">
          <div className="border-b border-border px-4 py-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-semibold text-foreground">Staff Feedback</h1>
              {totalUnread > 0 && (
          ...
          <div className="flex-1 space-y-0.5 overflow-y-auto p-2">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center py-16 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">No staff feedback yet</p>
              </div>
            ) : (
          ...
          <AnimatePresence mode="wait">
            {selectedThread ? (
              ...
              >
                ...
                <p className="mt-4 font-semibold text-foreground">Select a conversation</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  Choose a staff thread from the left panel
                </p>
              </motion.div>
            )}
          </AnimatePresence>
